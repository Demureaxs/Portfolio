...
function ExperienceCard(props) {
  return (
    <article className="flex flex-col mt-20 rounded-lg justify-center items-center space-y-2 sm:space-y-7 flex-shrink-0 w-full md:w-full xl:w-full snap-center snap-mandatory bg-[#292929] p-5 sm:p-10 ">
      <motion.img
